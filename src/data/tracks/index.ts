...
export const TRACKS: TrackDef[] = [
  ...
  t('drakonis', 3, 'Ossário', 'F R S S S R S D S S S S R S S S> S S S R S U S R S S L S', 1, [24]),
  ...
  t('newmojave', 4, 'Miragem', 'F L U S S S S S L S L S S S R S X S S R S U S R S D R S S S X S D> L S S', 4, [4, 6, 19, 28]),
  t('newmojave', 5, 'Vale da Morte', 'F L S R S S R S> S U S S S R S R S S L S L S S R S D R S R L S S R S', 2, [19, 31]),
  t('newmojave', 6, 'Poeira Vermelha', 'F R S L S R S S R S L S R S S R S L S R S S R S L S R S'),
  t('newmojave', 7, 'Oásis', 'F L S U S S L S R S L S U S S L S L S D R S D X S R S U R S R S D X S R S L', 1, [31]),
  // Nho
  t('nho', 1, 'Geleira', 'F L R S R S R L S S S R S S S L R S R S R L S S S> R S S', 2, [8, 23]),
  t('nho', 2, 'Labirinto', 'F U X S L S L S L S X S U X S L S L S L S X S D X S L S L S L S X S D X S L S L S L S X', 0, undefined, 3),
  t('nho', 3, 'Abismo', 'F R U L S L D J G J G S L S L S R S S R S L S L S S S S U S L S L D R S', 3, [24, 26, 29]),
  t('nho', 4, 'Nevasca', 'F L R S S R S S S U D S R S S R S L S L S R S R S S R L S S R S', 4, [5, 6, 8, 29]),
  t('nho', 5, 'Cristal', 'F S L S L S> J G S R S R S S B B B S R S> B B B S S R S J G J G S R S S R S S', 3, [13, 18, 23]),
  t('nho', 6, 'Pico Gelado', 'F R U> U S S S R L R J Gv S R S S X S R L S L D S L S U S L S X S L R L D S R', 3, [5, 6, 25]),
  t('nho', 7, 'Avalanche', 'F R S D R S L S R U S S S R S R S S L S S L U S R S R S> J Gv S R S L', 1, [23]),
  // Inferno
