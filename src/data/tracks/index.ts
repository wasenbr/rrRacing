...
export const TRACKS: TrackDef[] = [
  // Chem VI
  t('chem6', 1, 'Refinaria', 'F S R S J S S S S R S S B S S S R S S S S S S R S S S S'),
  ...
  // Drakonis
  t('drakonis', 1, 'Cratera Lunar', 'F S R S S U J S D R S S S S R S> S L S R S S S R B S S S', 2),
  ...
  // Bogmire
  t('bogmire', 1, 'Lamaçal', 'F S S R S S S J S S R B S R S U R L S> L S S L S J S S R S R D S S S S S R S S S', 3),
  ...
  t('newmojave', 3, 'Dunas', 'F S L B S S U U S L D D J S S S L U S J G S S L S L S D S> S R S R S S S S L'),
  ...
  t('nho', 3, 'Abismo', 'F R S> L S L S J G J G S L U L S R B S R S L D L B S J S S S L S L S R S', 2),
  ...
  t('inferno', 5, 'Brasa', 'F R S U L S S R S> D S< R U U S J S S R D D S S B S R S S', 2),
